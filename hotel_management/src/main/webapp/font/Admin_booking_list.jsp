...
<head>
    ...
    <link rel="stylesheet" href="./static/css/backend-plugin.min.css" type="text/css">
    <link rel="stylesheet" href="./static/css/backend.css" type="text/css">
    <link rel="stylesheet" href="./static/vendor/line-awesome/dist/line-awesome/css/line-awesome.min.css" type="text/css">
    <link rel="stylesheet" href="./static/vendor/remixicon/fonts/remixicon.css" type="text/css">

    <link rel="stylesheet" href="./static/vendor/tui-calendar/tui-calendar/dist/tui-calendar.css" type="text/css">
    <link rel="stylesheet" href="./static/vendor/tui-calendar/tui-date-picker/dist/tui-date-picker.css" type="text/css">
    <link rel="stylesheet" href="./static/vendor/tui-calendar/tui-time-picker/dist/tui-time-picker.css" type="text/css">
                ...
                <ul id="iq-sidebar-toggle" class="iq-menu">
                    ...
                    <li class=" ">
                        <a href="Admin_service_list.jsp" class="collapsed">
                            ...
                            <span class="ml-4">Service Admin</span>
                        </a>
                    </li>
                    <li class=" ">
                        <a href="Manager_service_list.jsp" class="collapsed">
                            <svg class="svg-icon" id="p-dash14" width="20" height="20"
                                xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none"
                                stroke="currentColor" stroke-width="2" stroke-linecap="round"
                                stroke-linejoin="round">
                            ...
                            <span class="ml-4">Service Manager</span>
                        </a>
                    </li>
                    <li class=" ">
                        <!--            th:href="@{}"-->
                        <a href="Admin_customer_list.jsp" class="collapsed">
                    ...
                    <li class=" ">
                        <!--            th:href="@{}"-->
                        <a href="Admin_account_list.jsp" class="collapsed">
                            <svg class="svg-icon" id="p-dash10" width="20" height="20"
                                xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none"
                                stroke="currentColor" stroke-width="2" stroke-linecap="round"
                                stroke-linejoin="round">
                        ...
                        <div class="card-body">
                            <div class="table-responsive">
                                <table class="data-table table" style="width:100%">
                                    ...
                                    <tbody>
                                    <tr th:block th:each="book: ${listBook}">
                                        <td style="text-align: center" text="${book.id}">1</td>
                                        <td style="text-align: center" text="${book.id}"></td>
                                        <td style="text-align: left" text="${book.bookTitle}"></td>
                                        <td style="text-align: center" text="${book.author}"></td>
                                        <td style="text-align: center" text="${book.brief}"></td>
                                    </tr>
                                    </tbody>
                                </table>
                            </div>
