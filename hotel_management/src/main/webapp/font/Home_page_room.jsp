...
<html>
  ...
  <body>
                  ...
                  <div class="row full-height align-items-center">
                    <div class="col-md-6 mx-auto">
                      <ul class="list-unstyled menu">
                        ...
                        <li class="active"><a href="Home_page_room.jsp">Rooms</a></li>
    ...
    <section class="site-hero inner-page overlay" style="background-image: url(/static/images/login/2126.jpg)" data-stellar-background-ratio="0.5">
      <div class="container">
    ...
    <section class="section bg-light">
      ...
      <div class="container">
        ...
        <div class="site-block-half d-block d-lg-flex bg-white" data-aos="fade" data-aos-delay="200">
          <a href="#" class="image d-block bg-image-2 order-2" style="background-image: url('/static/images/img_2.jpg');"></a>
      ...
      <div class="container">
        <div class="row mb-4">
          ...
          <div class="col-md-3 mb-5 pr-md-5 contact-info">
            ...
            <p><span class="d-block"><span class="fa fa-map-marker h5 mr-3 text-primary"></span>Address:</span> <span> 198 West 21th Street, <br> Suite 721 New York NY 10016</span></p>
            <p><span class="d-block"><span class="fa fa-phone h5 mr-3 text-primary"></span>Phone:</span> <span> (+1) 435 3533</span></p>
            <p><span class="d-block"><span class="fa fa-envelope-o h5 mr-3 text-primary"></span>Email:</span> <span> info@domain.com</span></p>
          </div>
          <div class="col-md-3 mb-5">
