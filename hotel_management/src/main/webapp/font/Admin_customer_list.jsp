                            ...
                            <div class="table-responsive">
                                <table class="data-table table" style="width:100%">
                                    ...
                                    <tr th:block th:each="book: ${listBook}">
                                        ...
                                        <td style="text-align: left" th:text="${book.id}"></td>
                                        <td style="text-align: left" th:text="${book.bookTitle}"></td>
                                        <td style="text-align: left" th:text="${book.author}"></td>  
                                        <td style="text-align: left" th:text="${book.author}"></td> 
                                        <td style="text-align: left" th:text="${book.author}"></td>                                                                 
                                        </td>
                                        <td>
                                            <div class="d-flex  list-action" style="margin-left: 41%;">
                                                <a class="badge bg-primary-light mr-2" data-toggle="tooltip" 
                                                   ...
                                                   href="#"><i class="lar la-edit" ></i></a>
                                                <a class="badge bg-danger-light mr-2" data-toggle="tooltip" 
                                                   data-placement="top" title="" data-original-title="Delete"
                                                   href="#"
                                                   onclick="return confirm('Do you want to delete this customer?');" ><i class="lar la-trash-alt "></i></a>
                                            </div>
                                        </td>
                                    </tr>
                                    </tbody>
