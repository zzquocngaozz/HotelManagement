                            ...
                            <div class="table-responsive">
                                <table class="data-table table" style="width:100%">
                                    ...
                                    <c:forEach items="${list}" var="s">
                                        <tr>
                                            <td style="text-align: center">${s.serviceId}</td>
                                            <td style="text-align: center">${s.serviceName}</td>
                                            <td style="text-align: center">${s.servicePrice}</td>
                                            <td style="text-align: center">${s.serviceStatus == 1?"Active":"Inactive"}</td>
                                            </td>
                                            <td>
